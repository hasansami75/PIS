                ...
                <div class="registration">
                    ...
                    <form role="form" action="index.php" enctype="multipart/form-data" method="post" id="registration-form" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="age" id="age" class="form-control input-custom" placeholder="Age" value="">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="password" id="key" class="form-control input-custom" placeholder="********">
                        </div>
                        <div class="form-group">
                            <label for="phone">Phone</label>
                            <input type="text" name="phone" id="phone" class="form-control input-custom" placeholder="Phone Number">
                        </div>
